...
import { Component, ElementRef, EventEmitter, Input, Output, NgModule, ViewEncapsulation, Inject, Optional, } from '@angular/core';
...
MdOption = __decorate([
    ...
    __param(1, Optional()), __param(1, Inject(MATERIAL_COMPATIBILITY_MODE)),
    __metadata("design:paramtypes", [ElementRef, Boolean])
], MdOption);
export { MdOption };
